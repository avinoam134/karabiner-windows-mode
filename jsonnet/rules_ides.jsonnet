...

{
  rules: [
    ...
    // Windows-like Ctrl+ mappings as Command for IDE editors
    k.rule('A (Ctrl) [Only IDEs]', k.input('a', ['control']), k.outputKey('a', ['command']), k.condition('if', bundle.ides)),
    k.rule('C (Ctrl) [Only IDEs]', k.input('c', ['left_control']), k.outputKey('c', ['command']), k.condition('if', bundle.ides)),
    ...
    k.rule('V (Ctrl) [Only IDEs]', k.input('v', ['control']), k.outputKey('v', ['command']), k.condition('if', bundle.ides)),
    ...
    k.rule('Left Arrow (Ctrl) [Only IDEs]', k.input('left_arrow', ['control']), k.outputKey('left_arrow', ['option']), k.condition('if', bundle.ides)),
    k.rule('Right Arrow (Ctrl) [Only IDEs]', k.input('right_arrow', ['control']), k.outputKey('right_arrow', ['option']), k.condition('if', bundle.ides)),
    k.rule('Backspace (Ctrl) [Only IDEs]', k.input('delete_or_backspace', ['control']), k.outputKey('delete_or_backspace', ['option']), k.condition('if', bundle.ides)),
    k.rule('Delete (Ctrl) [Only IDEs]', k.input('delete_forward', ['control']), k.outputKey('delete_forward', ['option']), k.condition('if', bundle.ides)),
  ],
}
